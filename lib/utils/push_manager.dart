...
// //推送管理
//
// const String _appKey = 'd9d5ee1af0b76ae46aed2299';
...
//           var map=message["extras"]["cn.jpush.android.EXTRA"];
//           var convert = JsonDecoder().convert(map);
//           var map2 = convert["page"];
//           if(map2!=null){
//             Get.toNamed(map2,arguments: convert["searchString"]);
//
//
//           }
