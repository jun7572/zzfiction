...
import com.june.fiction.MainActivity;
import com.june.fiction.R;
...
//        next(this);
    ...
    private View getContentView() {
        ...
        RelativeLayout.LayoutParams titleLP = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 100);
    ...
    private void fetchSplashAD(Activity activity, ViewGroup adContainer, SplashADListener adListener) {
        SplashAD splashAD = new SplashAD(activity, "52345", adListener);
